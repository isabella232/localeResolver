...
function requestHandler(localeFactorie, options) {
    ...
    // factory should already be instantiated
    debug('Locale factory to be used by locale resolver middleware: ', localeFactorie);
...
//            console.log('Time for fact(s) to be evaluated by locale resolution on nools: '+time+' ms');
        }
